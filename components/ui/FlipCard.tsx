...
export default function FlipCard({
  ...
  return (
    <div className={cn("group [perspective:1000px]", className)} style={{ height, width }} {...props}>
      <div
        className={cn(
      ...
      >
        ...
        >
          <div className="flex min-h-full flex-col gap-2">
            ...
            <p className="mt-1 border-t border-t-gray-200 py-4 text-lg font-medium leading-normal text-gray-100">
              {description}{" "}
            </p>
          </div>
        </div>
