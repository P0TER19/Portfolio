...
const Hero = () => {
  return (
    <div className='pb-20 pt-36'>
      ...
      <div className="h-screen w-full dark:bg-green bg-green dark:bg-grid-white/[0.05] bg-grid-black/[0.05]
        ...
        <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-black
          bg-green [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]" />
      </div>
